                  ...
                  <svg className="w-96 h-96 mx-auto" viewBox="0 0 200 200" fill="none">
                    ...
                    <g transform="translate(20, 100) scale(0.85)">
                      ...
                      <g className="led-display">
                        <path d="M44.14,60.69c-.14-.03-.28-.07-.4-.13l-4.02-2.11c-.42-.22-.48-.58-.14-.82.34-.23.96-.24,1.38-.02l4.02,2.11c.42.22.48.58.14.82-.24.16-.63.22-.98.15Z" fill="#9399a5"/>
                        <path d="M50.78,64.07c-.14-.03-.28-.07-.4-.13l-4.02-2.11c-.42-.22-.48-.58-.14-.82.34-.23.96-.24,1.38-.02l4.02,2.11c.42.22.48.58.14.82-.24.16-.63.22-.98.15Z" fill="#9399a5"/>
